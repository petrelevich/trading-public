...
public class WebServer {
    ...
    public WebServer(int port, EventLoopGroup webEventLoop, BondsRest bondsRest) {
        jvmGcMetrics = new JvmGcMetrics();
        jvmHeapPressureMetrics = new JvmHeapPressureMetrics();
        this.bondsRest = bondsRest;
        server = newServer(port, webEventLoop);
        server.start().join();
    ...
    private Server newServer(int port, EventLoopGroup webEventLoop) {
